...
class ResPartner(models.Model):
    ...
    # regine de tributação
    l10n_br_fiscal_tax_framework = fields.Selection(
    ...
    l10n_br_fiscal_cnae_main_id = fields.Many2one(
        comodel_name="l10n_br_fiscal.cnae",
        domain=[("internal_type", "=", "normal")],
        string="Main CNAE",
    )

    l10n_br_fiscal_cnae_secondary_ids = fields.Many2many(
        comodel_name="l10n_br_fiscal.cnae",
        domain="[('internal_type', '=', 'normal'), ('id', '!=', cnae_main_id)]",
        string="Secondary CNAEs",
    )

    l10n_br_fiscal_ind_ie_dest = fields.Selection(
    ...
    # l10n_br_fiscal_ind_final = fields.Selection(
    ...
    def _onchange_ind_ie_dest(self):
        for p in self:
            if p.ind_ie_dest == NFE_IND_IE_DEST_9:
                p.l10n_br_base_inscr_est = False
